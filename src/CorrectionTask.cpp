...
void CorrectionTask::Initialize() {
	...
	// u-vectors from MDC
	fManager.AddDetector("TracksMdc", DetectorType::TRACK, "Phi", "One", {pt}, {1});
	fManager.AddCut("TracksMdc", {"Pid", "Ycm"}, [](const double &pid, const double &y){ return pid > 13.99 && pid < 14.01 && y > -0.25 && y < -0.15; });
